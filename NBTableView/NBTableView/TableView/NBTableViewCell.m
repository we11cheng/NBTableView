...
- (void)layoutSubviews {
    ...
    self.separateLine.frame = CGRectMake(self.separateLineLeftPadding, self.nb_height-self.separateLineHeight-((self.separateLineHeight / [UIScreen mainScreen].scale) / 2), self.nb_width -self.separateLineLeftPadding - self.separateLineRightPadding, self.separateLineHeight);
